...
app.get('/', function(req, res) {
  ...
  app.get('/sarjataulukko', function(req, res) {
    customerController.fetchCustomersRevised().then(function(data){
        ...
        res.render('sarjataulukko', { // customers.html
  ...
  app.get('/customers', function(req, res) {
    customerController.fetchCustomersRevised2().then(function(data){
        console.log("Customers " + JSON.stringify(data));
        return data;
    }).then((customers) => {
        return customers;
...
app.get('/pelaajat', async function(req, res) {

    var pelaajat = null;
    try {
        pelaajat = await customerController.fetchPelaajatRevised(); // asynkronisia pyyntöjä
        console.log("tyypit haettu");
    }
    catch(error){
        console.log("EI onnistunut");
        ...
        res.render('pelaajat', { // Haetaan näkymistä users.html, jonne renderöidään alla olevat tiedot:
    ...
    app.get('/jalkapallo', async function(req, res) {
        ...
        try {
            ...
            res.render('jalkapallo', { // Haetaan näkymistä users.html, jonne renderöidään alla olevat tiedot:
...
app.get('/football', async function(req, res) {
        ...
        try {
            ...
            res.render('football', { // Haetaan näkymistä users.html, jonne renderöidään alla olevat tiedot:
